...
public class formPelanggan extends javax.swing.JFrame {
    ...
    private void viewData(){
        ...
        tabelku.addColumn("NO_TLP");
        
        try{
            String sql = "select * from pengguna order by username asc";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "insert into pengguna (username, password, nama_06911, alamat, no_tlp) VALUES (?,?,?,?,?)"; 
            pst = koneksi.prepareStatement(sql);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try{
            ...
            String no_tlp = txt_telp.getText();
            
            String sql = "update pengguna set password = '"+password+"',"
                    + "nama_06911 = '"+nama+"',"
                    + "alamat = '"+alamat+"',"
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        try{
            ...
            String sql = "select * from pengguna where username = '"+klik+"'";
            pst = koneksi.prepareStatement(sql);
            rs = pst.executeQuery();
            if(rs.next()){
                ...
                String nama = rs.getString("nama_06911");
                txt_nama.setText(nama);
                String alamat = rs.getString("alamat");
                txt_alamat.setText(alamat);
                String no_tlp = rs.getString("no_tlp");
                txt_telp.setText(no_tlp);
